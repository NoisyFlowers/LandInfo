...
public class DataPolicyFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View root = inflater.inflate(R.layout.fragment_datapolicy, container, false);
		
		TextView tV = ((TextView)root.findViewById(R.id.fragment_datapolicy_datapolicy_area));
		tV.setText(Html.fromHtml(getString(R.string.datapolicy)));
