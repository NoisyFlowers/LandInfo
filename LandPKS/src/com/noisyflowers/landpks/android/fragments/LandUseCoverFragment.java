...
public class LandUseCoverFragment extends PlotEditFragment {
	...
	public enum LandCover {
		...
		//old values
		LAND_COVER_901 (R.string.server_resource_land_cover_901, R.string.land_use_cover_fragment_land_cover_1),
		LAND_COVER_902 (R.string.server_resource_land_cover_902, R.string.land_use_cover_fragment_land_cover_2),
		LAND_COVER_903 (R.string.server_resource_land_cover_903, R.string.land_use_cover_fragment_land_cover_3),
		LAND_COVER_904 (R.string.server_resource_land_cover_904, R.string.land_use_cover_fragment_land_cover_4),
		LAND_COVER_905 (R.string.server_resource_land_cover_905, R.string.land_use_cover_fragment_land_cover_5),
		LAND_COVER_906 (R.string.server_resource_land_cover_906, R.string.land_use_cover_fragment_land_cover_6),
		LAND_COVER_907 (R.string.server_resource_land_cover_907, R.string.land_use_cover_fragment_land_cover_7),
		LAND_COVER_908 (R.string.server_resource_land_cover_908, R.string.land_use_cover_fragment_land_cover_8),
		LAND_COVER_909 (R.string.server_resource_land_cover_909, R.string.land_use_cover_fragment_land_cover_900);
		...
		static {
			for (LandCover s : LandCover.values()) {
				if (!displayNameLookup.containsKey(LandPKSApplication.getInstance().getString(s.displayName))) {
	...
	public void load(Plot plot) {
		...
		stringValue = getString(R.string.land_use_cover_fragment_land_cover_900).equals(stringValue) ? null : stringValue;
		RadioButton rB = null;
