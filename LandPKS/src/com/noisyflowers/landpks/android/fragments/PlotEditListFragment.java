 ...
 * interface.
 */
public class PlotEditListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    ***/
		...
		PlotEditListAdapter aD = new PlotEditListAdapter(getActivity(), android.R.layout.simple_list_item_1, fragments);
		setListAdapter(aD);
