...
public class Plot {
	...
	public enum Grazing {
		NONE (R.string.plot_grazing_1),
		CATTLE (R.string.plot_grazing_2),
		GOAT (R.string.plot_grazing_3),
		SHEEP (R.string.plot_grazing_4),
		WILDLIFE (R.string.plot_grazing_5);
