...
//The demo directory was missing from the afreechart jar file. 
...
public class ChartView extends View 
    ...
    private void initialize() {
    	this.setLayerType(View.LAYER_TYPE_SOFTWARE, null); // disable hw acceleration
    ...
    public static final int DEFAULT_MAXIMUM_DRAW_WIDTH = 1200;
...
//        }
    ...
    //TODO: My understanding of how view size is determined is shaky.  What follows appears to work, but I'm not sure it's the best way.
	@Override
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (heightMode == MeasureSpec.UNSPECIFIED) {
			heightSize = (int)Math.round(widthSize * 0.667);
		}
