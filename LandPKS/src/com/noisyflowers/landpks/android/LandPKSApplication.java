...
import com.noisyflowers.landpks.android.fragments.DataPolicyFragment;
...
import com.noisyflowers.landpks.android.fragments.LandUseFragment;
...
import com.noisyflowers.landpks.android.fragments.PrivacyFragment;
...
public class LandPKSApplication extends Application {
	...
	public static final boolean SHOW_MODEL_PRODUCTS = false;
	...
	public final void onCreate() {
		...
		credential = GoogleAccountCredential.usingAudience(this, "server:client_id:" + getString(R.string.lpks_web_client_id)); 		
	...
	public void initFragments() {
        ...
        bundle = new Bundle();
        bundle.putString("Name", getString(R.string.LandUseFragment_display_name));
        fragments.add(Fragment.instantiate(this, LandUseFragment.class.getName(), bundle));
        bundle = new Bundle();
        ...
        /***
        bundle = new Bundle();
        bundle.putString("Name", getString(R.string.PrivacyFragment_display_name));
        aboutFragments.add(Fragment.instantiate(this, PrivacyFragment.class.getName(), bundle));  	
        ***/
        bundle = new Bundle();
        bundle.putString("Name", getString(R.string.DataPolicyFragment_display_name));
        aboutFragments.add(Fragment.instantiate(this, DataPolicyFragment.class.getName(), bundle));  	
        bundle = new Bundle();
	...
	public void setPlot(Plot plot, boolean initFragments) {
		currentPlot = plot;
		if (initFragments) { 
			initFragments();
	...
	public String analyticResults(Plot plot) {
		...
		sB.append(getString(R.string.results_fragment_latitude) + " " + (plot.latitude == null ? "N/A" : plot.latitude) + "\n");
		sB.append(getString(R.string.results_fragment_longitude) + " " + (plot.longitude == null ? "N/A" : plot.longitude) + "\n");
		...
		if (plot.ID != null) { //if null then this is Quick Climate plot
	...
	private Plot qcPlot = null;
	public void setQCPlot(Plot plot) {
		this.qcPlot = plot;
	}
	public Plot getQCPlot() {
		return qcPlot;
	}
}
