...
public class AboutActivity extends ActionBarActivity /*implements View.OnLongClickListener*/ {
	...
	private PlotEditPagerAdapter pagerAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	List<Fragment> fragments = LandPKSApplication.getInstance().getAboutFragments();
        ...
        this.pagerAdapter  = new PlotEditPagerAdapter(super.getSupportFragmentManager(), fragments);
